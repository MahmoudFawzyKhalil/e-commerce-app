...
public class EmailGateway {
    ...
    public static void sendUserRegistrationConfirmationEmail( String receiverMail ) throws EmailException {
        ...
        htmlEmail.setHtmlMsg( createConfirmationEmailBody( receiverMail ) );
        htmlEmail.send();
    }

    public static void main( String[] args ) {
        try {
            sendUserRegistrationConfirmationEmail( "mahmoudfawzykhalil98@gmail.com" );
        } catch ( EmailException e ) {
            e.printStackTrace();
        }
    }

    private static String createConfirmationEmailBody( String receiverEmail ) {
