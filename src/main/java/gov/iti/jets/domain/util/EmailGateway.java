...
public class EmailGateway {
    ...
    public static void sendUserRegistrationConfirmationEmail( String receiverMail ) throws EmailException {
        var htmlEmail = createNewEmail();
        htmlEmail.setSubject( "Confirm your ChocoTown account" );
        htmlEmail.addTo( receiverMail );
        htmlEmail.setHtmlMsg( createRegistrationConfirmationEmailBody( receiverMail ) );
        htmlEmail.send();
    }

    public static void main( String[] args ) {
        try {
            sendOrderConfirmationEmail( "mahmoudfawzykhalil98@gmail.com", "123" );
        } catch ( EmailException e ) {
            e.printStackTrace();
        }
    }

    private static String createRegistrationConfirmationEmailBody( String receiverEmail ) {
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "    <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td align=\"center\" style=\"background-color: #3b5f8a;\"><![endif]-->\n" +
                "    \n" +
                "\n" +
                ...
                "        \n" +
                "<div align=\"center\">\n" +
                "  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:arial,helvetica,sans-serif;\"><tr><td style=\"font-family:arial,helvetica,sans-serif;\" align=\"center\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"https://unlayer.com\" style=\"height:64px; v-text-anchor:middle; width:290px;\" arcsize=\"6.5%\" stroke=\"f\" fillcolor=\"#17255c\"><w:anchorlock/><center style=\"color:#ffffff;font-family:arial,helvetica,sans-serif;\"><![endif]-->\n" +
                "    <a href=\"https://unlayer.com\" target=\"_blank\" style=\"box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #17255c; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:46%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #000000; border-top-style: solid; border-top-width: 0px; border-left-color: #000000; border-left-style: solid; border-left-width: 0px; border-right-color: #000000; border-right-style: solid; border-right-width: 0px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 0px;\">\n" +
