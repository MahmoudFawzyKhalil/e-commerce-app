...
//        users.add( user5 );
//
//        User user6 = new User( "Salma", "Fayez", "salma@gmail.com", "123456789", "01117950456", LocalDate.ofYearDay( 1997, 120 ), 4000, "Engineer", Role.CUSTOMER, new Address( "Iti", "Cairo" ) );
//        users.add( user6 );
//
//        User user7 = new User( "Ahmed", "Osama", "Osos@gmail.com", "123456789", "01117950457", LocalDate.ofYearDay( 1997, 88 ), 1000, "Java Developer", Role.CUSTOMER, new Address( "iti", "Giza" ) );
//        users.add( user7 );
//
//        User user8 = new User( "Ahmed", "Ashrf", "Ashrf@gmail.com", "123456789", "01117950458", LocalDate.ofYearDay( 1997, 90 ), 20000, "Web Developer", Role.CUSTOMER, new Address( "iti", "Cairo" ) );
//        users.add( user8 );
//
//        User user9 = new User( "Hend", "Mohamed", "hend@gmail.com", "123456789", "01117950459", LocalDate.ofYearDay( 1997, 14 ), 40000, "Java Developer", Role.CUSTOMER, new Address( "iti", "Cairo" ) );
//        users.add( user9 );
//
//        User user10 = new User( "Hafsa", "Mohammed", "hafsa@gmail.com", "123456789", "01117950450", LocalDate.ofYearDay( 1997, 80 ), 30000, "Web Developer", Role.CUSTOMER, new Address( "london street", "Cairo" ) );
//        users.add( user10 );
//
//        // PERSIST USERS ************************
