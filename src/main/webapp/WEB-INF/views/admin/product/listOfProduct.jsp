                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                          ...
                          <td class="px-2 py-2 text-sm text-gray-900 ">CACsdasdsadsad sadssda sada asdsadas d dsadjsadkjsah sadsajdnksan dsad asdjasbhdbsahjdvshjad sdasdashdbhsas sdasdb</td>
                          ...
                          <td class="relative py-2 pl-3 pr-4 text-sm font-medium text-right whitespace-nowrap sm:pr-6">
                            <a href="addProduct.jsp" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">, AAPS0L</span></a>
                          </td>
                        </tr>
                        <tr>
                            <td class="py-2 pl-4 pr-3 text-sm text-gray-500 whitespace-nowrap sm:pl-6">1</td>
