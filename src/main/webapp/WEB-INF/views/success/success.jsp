...
<head>
    ...
    <title>Your order is on its way! | ChocoTown</title>
</head>
...
<section>
    <div class="min-h-full px-4 py-16 bg-white sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <div class="mx-auto max-w-max">
            <main class="sm:flex">
                <p class="text-4xl font-extrabold text-green-400 sm:text-5xl">Success!</p>
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">Your order is on
                            its
                            way</h1>
                        <p class="mt-1 text-base text-gray-500">Please click the link below to go back to the home
                            page.</p>
                    </div>
