        ...
        <div class="px-4 py-5 shadow-md bg-gray-50 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Edit your profile</h3>
                    <p class="mt-1 text-sm text-gray-500">Give us your latest contact info! 📝</p>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form id="updateProfileForm" action="<c:url value="/profile"/>" method="POST">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="first-name" class="block text-sm font-medium text-gray-700">First
                                    name</label>
                                <input value="${user.firstName}" disabled type="text" name="first-name" id="first-name"
                                       autocomplete="given-name"
                                       class="block w-full mt-1 bg-gray-200 border-gray-300 rounded-md shadow-sm cursor-not-allowed sm:text-sm caret-transparent">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="last-name"
                                    ...
                                    name</label>
                                <input value="${user.lastName}" disabled type="text" name="last-name" id="last-name"
                            ...
                            <div class="col-span-6">
                                <label for="email-address" class="block text-sm font-medium text-gray-700">Email
                                    address</label>
                                <input disabled value="${user.email}" type="text" name="email-address"
                                       id="email-address"
                                       autocomplete="email"
                            ...
                            <div class="col-span-6">
                                <label for="phoneNumber" class="block text-sm font-medium text-gray-700">Phone
                                    number</label>
                                <input value="${user.phoneNumber}" type="tel" name="phoneNumber" id="phoneNumber"
                            ...
                            <div class="col-span-6">
                                ...
                                <input value="${user.birthdayFormatted}" disabled type="text" name="birthdate"
                                       id="birthdate"
                                       class="block w-full mt-1 bg-gray-200 border-gray-300 rounded-md shadow-sm cursor-not-allowed caret-transparent sm:text-sm">
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                <label for="job" class="block text-sm font-medium text-gray-700">Job</label>
                                <input value="${user.job}" type="text" name="job" id="job"
                                       class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <span class="hidden text-xs text-red-500"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="creditLimit" class="block text-sm font-medium text-gray-700">Credit
                                    limit</label>
                                <input value="${user.creditLimit}" type="number" name="creditLimit" id="creditLimit"
                                       class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <span class="hidden text-xs text-red-500"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="streetAddress" class="block text-sm font-medium text-gray-700">Street
                                    address</label>
                                <input value="${user.address.street}" type="text" name="streetAddress"
                                       id="streetAddress"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input value="${user.address.city}" type="text" name="city" id="city"
