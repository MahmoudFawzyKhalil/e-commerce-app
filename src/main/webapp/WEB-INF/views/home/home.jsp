...
<section id="searchBar" class="mt-5 md:self-center md:w-9/12">
    <div class="flex ml-5">
        ...
        <!-- CATEGORY DROP DOWN -->
        <div class="relative inline-block w-32 mx-5">
            <select
                    class="block w-full px-4 py-2 pr-8 leading-tight bg-white border border-gray-300 rounded appearance-none focus:outline-none hover:border-gray-500 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500">
...
<section id="productsList">
        ...
        <div class="max-w-2xl px-4 py-16 mx-auto sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div class="grid grid-cols-1 mt-8 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 ">
                ...
                <div class="p-2 rounded-lg shadow-md cursor-pointer hover:shadow-xl">
                    <div class="relative">
                        <div class="relative w-full overflow-hidden rounded-lg h-72">
                            <img src="https://m.media-amazon.com/images/I/41Se268UxPL._AC_.jpg"
                                 alt="Chocolate image." class="object-scale-down object-center w-full h-full">
                        </div>
                        <div class="relative mt-4">
                            <h3 class="text-sm font-medium text-gray-900">Galaxy</h3>
                            <p class="mt-1 text-sm text-gray-500">Jewels</p>
                        </div>
                        <div
                                class="absolute inset-x-0 top-0 flex items-end justify-end p-4 overflow-hidden rounded-lg h-72">
                            <div aria-hidden="true"
    ...
    <div class="flex justify-center">
        ...
        <!-- SPINNER -->
        <svg class="hidden w-32 m-auto " xmlns="http://www.w3.org/2000/svg"
